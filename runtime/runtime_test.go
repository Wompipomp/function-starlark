...
func TestBasicExecution(t *testing.T) {
	...
	globals, err := rt.Execute("x = 1 + 2", starlark.StringDict{})
	if err != nil {
...
func TestCacheMiss(t *testing.T) {
	...
	_, err := rt.Execute("x = 1", starlark.StringDict{})
	if err != nil {
		t.Fatalf("first execute error: %v", err)
	}

	_, err = rt.Execute("x = 2", starlark.StringDict{})
	if err != nil {
		t.Fatalf("second execute error: %v", err)
	}
...
func TestRuntimeError(t *testing.T) {
	...
	_, err := rt.Execute("x = undefined_var", starlark.StringDict{})
	if err == nil {
...
func TestLoadBlocked(t *testing.T) {
	...
	_, err := rt.Execute(`load("foo.star", "bar")`, starlark.StringDict{})
	if err == nil {
...
func TestPrintRouting(t *testing.T) {
	...
	_, err := rt.Execute(`print("hello world")`, starlark.StringDict{})
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestSandboxNoOS(t *testing.T) {
	...
	_, err := rt.Execute(`x = os.getenv("HOME")`, starlark.StringDict{})
	if err == nil {
...
func TestSandboxNoSys(t *testing.T) {
	...
	_, err := rt.Execute(`x = sys.exit(1)`, starlark.StringDict{})
	if err == nil {
...
func TestSandboxNoIO(t *testing.T) {
	...
	_, err := rt.Execute(`f = open("test.txt")`, starlark.StringDict{})
	if err == nil {
...
func TestSandboxNoTime(t *testing.T) {
	...
	_, err := rt.Execute(`t = time.now()`, starlark.StringDict{})
	if err == nil {
...
func TestConcurrentExecution(t *testing.T) {
	...
	for i := 0; i < goroutines; i++ {
		...
		go func(idx int) {
			defer wg.Done()
			_, err := rt.Execute("x = 1 + 2", starlark.StringDict{})
			errs[idx] = err
		}(i)
	}
...
func TestPredeclaredAccess(t *testing.T) {
	...
	globals, err := rt.Execute("x = greeting", predeclared)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
